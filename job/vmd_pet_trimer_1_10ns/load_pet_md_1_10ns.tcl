# VMD script: PET trimer MD extracted structures, 1-10 ns
...
mol new "pet_trimer_md_1_10ns.xyz" type xyz waitfor all
mol delrep 0 top
...
puts "Loaded PET trimer MD extracted structures, 1-10 ns"
puts "Frames: $nframes"
